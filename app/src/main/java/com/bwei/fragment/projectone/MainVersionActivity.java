...
import java.io.File;
public class MainVersionActivity extends AppCompatActivity {
    @Override
    ...
    private void downLoadApk(String path) {
        ...
        x.http().post(params, new Callback.ProgressCallback<File>() {
            ...
            public void onSuccess(File result) {
                Toast.makeText(MainVersionActivity.this, "下载成功", Toast.LENGTH_SHORT).show();
                //apk下载完成后 调用系统的安装方法
                Intent intent = new Intent(Intent.ACTION_VIEW);
                intent.setDataAndType(Uri.fromFile(result), "application/vnd.android.package-archive");
                startActivity(intent);
                Toast.makeText(MainVersionActivity.this, "安装成功", Toast.LENGTH_SHORT).show();
